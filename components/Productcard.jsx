      ...
      <div className="py-4 flex justify-between items-end ">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex gap-2 items-center">
            ...
            <p className="text-[10px] md:text-sm text-gray-300">{sold} Sold</p>
          </div>
        </div>{" "}
        <div
          onClick={addToCart}
          className="bg-primarycolor rounded-full flex justify-center items-center md:w-[35px] w-[25px] md:h-[35px] h-[25px] cursor-pointer"
        >
